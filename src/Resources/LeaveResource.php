...
class LeaveResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return array(
            'index' => \Sorethea\Hrms\Resources\LeaveResource\Pages\ListLeaves::route('/'),
            'create' => \Sorethea\Hrms\Resources\LeaveResource\Pages\CreateLeave::route('/create'),
            'edit' => \Sorethea\Hrms\Resources\LeaveResource\Pages\EditLeave::route('/{record}/edit'),
            'view' => \Sorethea\Hrms\Resources\LeaveResource\Pages\ViewLeave::route('/{record}'),
            'activities' => \Sorethea\Hrms\Resources\LeaveResource\Pages\ListLeaveActivities::route('/{record}/activities'),
        );
    }
