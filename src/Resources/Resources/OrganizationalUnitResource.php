...
class OrganizationalUnitResource extends Resource
{
    ...
    {
        return [
            'index' => \Sorethea\Hrms\Resources\Resources\OrganizationalUnitResource\Pages\ListOrganizationalUnits::route('/'),
            'create' => \Sorethea\Hrms\Resources\Resources\OrganizationalUnitResource\Pages\CreateOrganizationalUnit::route('/create'),
            'edit' => \Sorethea\Hrms\Resources\Resources\OrganizationalUnitResource\Pages\EditOrganizationalUnit::route('/{record}/edit'),
        ];
    }
