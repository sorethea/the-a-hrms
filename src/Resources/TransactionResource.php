...
class TransactionResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return [
            'index' => \Sorethea\Hrms\Resources\TransactionResource\Pages\ListTransactions::route('/'),
            'create' => \Sorethea\Hrms\Resources\TransactionResource\Pages\CreateTransaction::route('/create'),
            'edit' => \Sorethea\Hrms\Resources\TransactionResource\Pages\EditTransaction::route('/{record}/edit'),
        ];
    }
